        ...
        return (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-3 sm:space-y-4">
              <input type="text" placeholder="Name" defaultValue='CSE' className="w-full text-sm p-2 border rounded outline-blue-500"/>
              <input type="text" placeholder="Head" defaultValue='John Alva' className="w-full text-sm p-2 border rounded outline-blue-500"/>
              <input type="email" placeholder="Email" defaultValue='john@gmail.com' className="w-full text-sm p-2 border rounded outline-blue-500"/>
            </div>
            <div className="space-y-3 sm:space-y-4">
              ...
              <input type="text" placeholder="No. of Students" defaultValue='1500' className="w-full text-sm p-2 border rounded outline-blue-500"/>

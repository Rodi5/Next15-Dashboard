        ...
        return (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-3 sm:space-y-4">
              <input type="text" placeholder="Name of Asset" className="w-full text-sm p-2 border rounded outline-blue-500"/>
              <input type="text" placeholder="Subject" className="w-full text-sm p-2 border rounded outline-blue-500"/>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <input type="text" placeholder="Type" className="w-full text-sm p-2 border rounded outline-blue-500"/>
              <input type="text" placeholder="Price" className="w-full text-sm p-2 border rounded outline-blue-500"/>
              <input type="text" placeholder="Year" className="w-full text-sm p-2 border rounded outline-blue-500"/>
